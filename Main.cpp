/ I affirm that all code given below was written solely by me, Brandon J. Banks, and that any help
...
int main() {
	...
	*/
	...
	// Ketchum has the Ride Sun Valley Bike Festival, Spokane has SpokeFest, 
	// and Seattle has the Evergreen Mountain Bike Festival
	// They are all famous freeride mountail bikers (and Kurt Sorge is the best out of all of them)
